<?php if (!defined('THINK_PATH')) exit();?>		<div class="child">
			...
			<div class="btn-group" role="group" aria-label="...">			  
			  ...
			  <a class="btn btn-default"  id="sch" ><span class="glyphicon glyphicon-pencil"></span> 修改</a>
			   ...
			   <div class=" row edit-top">
			    <div class="col-md-3">
					<input type="text" class="form-control" name="search-name" placeholder="查询姓名/账号/手机号">
			    </div>
			    <div class="col-md-3">
		       ...
		       <div>
		        <table class="table table-striped table-hover" id="childtb">
			         <thead>
			           <tr class="success"><th>编号</th><th>账号</th><th>班级</th><th>姓名</th><th>手机号</th><th>性别</th><th>累计分数</th><th>总排名</th></tr>
			         </thead>
			         <tbody>
			...
			<div id="search_name"><?php echo ($search_name); ?></div>
			...
			<script type="text/javascript" src="/Public/Home/js/student.js"></script>
</div>