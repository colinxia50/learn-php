			  ...
			  <li class="active">缴费列表</li>
		       ...
		       <table class="table table-striped table-hover table-bordered">
					 ...
					 <?php if(!empty($Child)): if(is_array($Child)): $i = 0; $__LIST__ = $Child;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							  ...
							  <td>
								  <?php echo ($vo["title"]); ?>
								  <?php if($vo["is_pay"] == 1): ?><a style="margin-left:20px;" class="btn btn-info btn-sm view-result" href="javascript:void(0)" iid="<?php echo ($vo["article_id"]); ?>"> 查看</a><?php endif; ?>
							  </td>
							  <td>
								<?php echo ($vo["coin"]); ?>
							   ...
							   <td>
								   ...
								   <?php if($vo["is_pay"] == 1): ?><span style="color:green;">已支付</span>
									   <?php else: ?>
									   <span style="color:red;">未支付</span><?php endif; ?>
							   </td>
							   <td>
								   <?php if($vo["is_pay"] == 1): echo ($vo["pay_time"]); endif; ?>
							   </td>
...
<script type="text/javascript" src="/zzb/Public/Home/js/pay.js"></script>
