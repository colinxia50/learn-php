...
<div class="header">
    ...
    <div class="table-responsive col-xs-12" style="margin-top:10px;">
        <table class="table">
            <tr><th></th><th>文章名</th><th>学生名</th><th>能量币</th><th>缴费日期</th><th>佣金</th><th>小计</th><th>合计</th></tr>
            <?php if(isset($HabitData)): if(is_array($HabitData)): $i = 0; $__LIST__ = $HabitData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($vo["pay_coin"]); ?></td>
                        <td><?php echo ($vo["pay_time"]); ?></td>
                        <td>0</td>
                        <td><?php echo ($vo["pay_coin"]); ?></td>
                        <td><?php echo ($vo["total_coin"]); ?></td>
                        <!--<td>-->
...
<script type="text/javascript" src="/Public/Admin/js/habit.js"></script>