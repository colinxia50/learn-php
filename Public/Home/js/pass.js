$(function(){
    ...
    $('#add-infos').click(function(){
        $.ajax({
            url:ThinkPHP['MODULE']+'/message/index',
            type:'POST',
            beforeSend:function(){
                $('.main-right').empty();
                $('#loadin').show();
    ...
    $('.edit').click(function(){
        ...
        $.ajax({
            url:ThinkPHP['MODULE']+'/Articles/edit',
            type:'POST',
            data:{
                id:id,
            },
    ...
    $('.del').click(function(){
        ...
        var news=$(this);
        $.ajax({
            url:ThinkPHP['MODULE']+'/Articles/delete',
            type:'POST',
            data:{
                id:id,
            },
    ...
    //禁用表单自动提交
    $(".addinfos").submit(function(e){
        e.preventDefault();
    });
    //发布新闻
    $('#fb-infos').click(function(){
        var img=new Array();
        var i=0;
        ...
        $.ajax({
            url:ThinkPHP['MODULE']+'/infos/addinfos',
            type:'POST',
            data:{
            ...
            success:function(data,response,status){
                if(data>0){
                    $.ajax({
                        url:ThinkPHP['MODULE']+'/Infos/index',
                        type:'POST',
                        beforeSend:function(){
                            $('.main-right').empty();
                            $('#loadin').show();
    ...
    //ajax分页点击
    $('.main-right').unbind().on('click','.page_infos',function(){
        var page=$(this).attr('page');
        $.ajax({
            url:ThinkPHP['MODULE']+'/Articles/pass',
            type:'POST',
            data:{
                page:page,
            },
